...
class OfferHeaderCell: BaseTableCell {
    ...
    func setupContents() {
        ...
        allLabel.anchor(top: nil, left: nil, bottom: nil, right: arrowIcon.leftAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 8, width: 60, height: 16)
